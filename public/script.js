﻿(function () {
  ...
  const I18N = {
    en: {
      ...
      home: {
        metaTitle: "ColabGames | GuessChess",
        metaDescription: "ColabGames builds strategy games with a competitive focus. Discover GuessChess and official support links.",
        kicker: "INDIE GAME STUDIO",
        title: "ColabGames builds games around fast decisions.",
        lead: "Current focus: GuessChess, a hidden-information strategy game with bot mode, custom rooms, and competitive online multiplayer.",
        playButton: "Download GuessChess",
        appButton: "Game page",
      ...
      chess: {
        metaTitle: "GuessChess | ColabGames",
        metaDescription: "Official GuessChess page with key features and download links.",
        kicker: "GAME PAGE",
        title: "GuessChess",
        lead: "Hidden pieces, visible strategy. Read your opponent plan before you see every piece.",
        openWeb: "Download GuessChess",
      ...
      support: {
        ...
        metaDescription: "Official ColabGames support page for GuessChess: contacts, quick FAQ, and bug report template.",
        kicker: "SUPPORT",
        title: "GuessChess Support",
        ...
        templateBody: "Subject: GuessChess bug report\n\nUsername:\nPlatform: Android / Web\nApp version:\nDate and time of issue:\nShort description:\nSteps to reproduce:\nScreenshot or video (if available):"
      },
      privacy: {
        metaTitle: "Privacy Policy | ColabGames",
        metaDescription: "Official ColabGames privacy policy for GuessChess.",
        kicker: "LEGAL",
        title: "Privacy Policy",
        effectiveDate: "Effective date: April 9, 2026",
        s1h: "1. Data Controller",
        s1p: "ColabGames is the data controller for personal data processed through GuessChess and related online services.",
      ...
      terms: {
        ...
        metaDescription: "Terms and conditions for GuessChess and ColabGames services.",
        kicker: "LEGAL",
        title: "Terms and Conditions",
        updatedDate: "Last updated: April 9, 2026",
        s1h: "1. Acceptance",
        s1p: "By using GuessChess, you agree to these terms. If you do not agree, do not use the service.",
        s2h: "2. User Account",
      ...
      delete: {
        ...
        metaDescription: "Official ColabGames instructions to request GuessChess account deletion.",
    ...
    it: {
      ...
      home: {
        metaTitle: "ColabGames | GuessChess",
        metaDescription: "ColabGames crea giochi strategici con focus competitivo. Scopri GuessChess e i link ufficiali.",
        kicker: "INDIE GAME STUDIO",
        title: "ColabGames crea giochi basati su decisioni rapide.",
        lead: "Focus attuale: GuessChess, gioco strategico a informazione incompleta con bot, stanze private e multiplayer competitivo online.",
        playButton: "Scarica GuessChess",
      ...
      chess: {
        metaTitle: "GuessChess | ColabGames",
        metaDescription: "Pagina ufficiale GuessChess con funzioni principali e link download.",
        kicker: "PAGINA GIOCO",
        title: "GuessChess",
        lead: "Pezzi nascosti, strategia visibile. Leggi il piano avversario prima di vedere ogni pezzo.",
        openWeb: "Scarica GuessChess",
      ...
      support: {
        ...
        metaDescription: "Pagina supporto ufficiale ColabGames per GuessChess: contatti, FAQ e template bug report.",
        kicker: "SUPPORTO",
        title: "Supporto GuessChess",
        ...
        templateBody: "Oggetto: Bug report GuessChess\n\nUsername:\nPiattaforma: Android / Web\nVersione app:\nData e ora del problema:\nDescrizione breve:\nPassi per riprodurre:\nScreenshot o video (se disponibile):"
      },
      privacy: {
        metaTitle: "Privacy Policy | ColabGames",
        metaDescription: "Informativa privacy ufficiale ColabGames per GuessChess.",
        kicker: "LEGALE",
        title: "Informativa Privacy",
        effectiveDate: "Data efficacia: 9 Aprile 2026",
        s1h: "1. Titolare del Trattamento",
        s1p: "ColabGames e il titolare del trattamento dei dati personali raccolti tramite GuessChess e servizi online collegati.",
        s2h: "2. Dati Raccolti",
      ...
      terms: {
        ...
        metaDescription: "Termini e condizioni di utilizzo per GuessChess e servizi ColabGames.",
        kicker: "LEGALE",
        title: "Termini e Condizioni",
        updatedDate: "Ultimo aggiornamento: 9 Aprile 2026",
        s1h: "1. Accettazione",
        s1p: "Usando GuessChess accetti questi termini. Se non li accetti, non usare il servizio.",
      ...
      delete: {
        metaTitle: "Delete Account | ColabGames",
        metaDescription: "Istruzioni ufficiali ColabGames per richiedere la cancellazione account GuessChess.",
    ...
    es: {
      ...
      home: {
        metaTitle: "ColabGames | GuessChess",
        metaDescription: "ColabGames crea juegos de estrategia con enfoque competitivo. Descubre GuessChess y enlaces oficiales.",
        kicker: "ESTUDIO INDIE",
        title: "ColabGames crea juegos basados en decisiones rapidas.",
        lead: "Enfoque actual: GuessChess, juego estrategico de informacion oculta con modo bot, salas privadas y multijugador online competitivo.",
        playButton: "Descargar GuessChess",
      ...
      chess: {
        metaTitle: "GuessChess | ColabGames",
        metaDescription: "Pagina oficial de GuessChess con funciones principales y enlaces de descarga.",
        kicker: "PAGINA DEL JUEGO",
        title: "GuessChess",
        lead: "Piezas ocultas, estrategia visible. Lee el plan rival antes de ver todas las piezas.",
        openWeb: "Descargar GuessChess",
      ...
      support: {
        ...
        metaDescription: "Pagina oficial de soporte ColabGames para GuessChess: contactos, FAQ rapida y plantilla de bug report.",
        kicker: "SOPORTE",
        title: "Soporte GuessChess",
        ...
        templateBody: "Asunto: Bug report GuessChess\n\nUsuario:\nPlataforma: Android / Web\nVersion app:\nFecha y hora del problema:\nDescripcion breve:\nPasos para reproducir:\nCaptura o video (si disponible):"
      },
      privacy: {
        metaTitle: "Politica de Privacidad | ColabGames",
        metaDescription: "Politica oficial de privacidad de ColabGames para GuessChess.",
        kicker: "LEGAL",
        title: "Politica de Privacidad",
        effectiveDate: "Fecha de vigencia: 9 Abril 2026",
        s1h: "1. Responsable del Tratamiento",
        s1p: "ColabGames es el responsable del tratamiento de datos personales procesados mediante GuessChess y servicios online relacionados.",
      ...
      terms: {
        ...
        metaDescription: "Terminos y condiciones de uso para GuessChess y servicios ColabGames.",
        kicker: "LEGAL",
        title: "Terminos y Condiciones",
        updatedDate: "Ultima actualizacion: 9 Abril 2026",
        s1h: "1. Aceptacion",
        s1p: "Al usar GuessChess aceptas estos terminos. Si no estas de acuerdo, no uses el servicio.",
      ...
      delete: {
        ...
        metaDescription: "Instrucciones oficiales de ColabGames para solicitar eliminacion de cuenta GuessChess.",
